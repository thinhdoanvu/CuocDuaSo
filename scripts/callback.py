...
class image_feature:
    ...
    def __init__(self):
        ...
        # subscribed Topic
        self.subscriber = rospy.Subscriber("team1/camera/rgb/compressed", CompressedImage, self.callback,  queue_size = 1)
        if VERBOSE :
    ...
    def callback(self, ros_data):
        ...
        for contour in contours:
            ...
            if 300< w * h < 10000:
                ...
                dienTich = a*b
                # print(dienTich)
                if a % b < 50 and y > 40 and x2 < 320 and x2 > 300 and dienTich > 800 and dienTich < 4000:
        ...
        try:
            ...
            cropped1 = mask2[y_bb:y2_bb, x_bb:xtb]
            cropped2 = mask2[y_bb:y2_bb, xtb:x2_bb]

            #dem pixel 
            pixel_trai = np.count_nonzero(cropped1)
            pixel_phai = np.count_nonzero(cropped2)
