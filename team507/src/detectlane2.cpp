...
int DetectLane2::slideThickness = 10;
int DetectLane2::BIRDVIEW_WIDTH = 240;
int DetectLane2::BIRDVIEW_HEIGHT = 320;
int DetectLane2::VERTICAL = 0;
int DetectLane2::HORIZONTAL = 1;
Point DetectLane2::null = Point();

DetectLane2::DetectLane() {
...
vector<Point> DetectLane2::getLeftLane()
{
    return leftLane;
}

vector<Point> DetectLane2::getRightLane()
{
    return rightLane;
}

void DetectLane2::update(const Mat &src)
{
...
//====================================================================================================
Mat DetectLane2::preProcess(const Mat &src)
{
...
Mat DetectLane2::laneInShadow(const Mat &src)
{
...
void DetectLane2::fillLane(Mat &src)
{
    vector<Vec4i> lines;
...
vector<Mat> DetectLane2::splitLayer(const Mat &src, int dir)
{
    int rowN = src.rows;
    int colN = src.cols;
    std::vector<Mat> res;
...
vector<vector<Point> > DetectLane2::centerRoadSide(const vector<Mat> &src, int dir)
{
...
void DetectLane2::detectLeftRight(const vector<vector<Point> > &points)
{
...
Mat DetectLane2::morphological(const Mat &img)
{
    Mat dst;
...
Mat DetectLane2::birdViewTranform(const Mat &src)
{
